...
/**
 * Controller para cadastrar os produtos
...
public class ControllerProductCreate {
    ...
    public ResponseEntity <ProductCreateResponseDTO> create (@Valid @RequestBody CreateRequestDTO articles, HttpServletRequest httpServletRequest){
